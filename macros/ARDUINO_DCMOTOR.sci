...
//                    end
                ...
                elseif  type_shield==2 then
                    ...
                    [gettext('Direction pin ');
                     gettext('Enable (speed) Pin');
                     gettext('Motor number (between 1 and 4)')],list('vec',1,'vec',1,'vec',1), exprs(3:5))
                    if ~ok then break;  end //cancel  
                ...
                elseif  type_shield==3 then
                    ...
                    [gettext('PWM 1 Pin');
                     gettext('PWM 2 Pin');
                     gettext('Motor number (between 1 and 3)')],list('vec',1,'vec',1,'vec',1), exprs(3:5))
                    if ~ok then break;  end //cancel  
                    if (motor_number < 1 | motor_number>4)
                        mess=[mess ;_("Motor number must be between 1 and 4")]
                        ok = %f
